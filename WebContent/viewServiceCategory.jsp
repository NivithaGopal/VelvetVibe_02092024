    ...
    <div class="container">
        <div class="table-container">
            ...
            <div class="d-flex justify-content-start">
                <a href="addServiceCategory.jsp" class="btn btn-custom">Add New Category</a>
            </div>
            <%
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="action-icons">
                            <a href="editServiceCategory.jsp?service_id=<%=category.getCategoryId()%>" title="Edit">
                                <i class="bi bi-pencil-square" style="color: #333;"></i>
                            </a>
                            <a href="#" onclick="confirmDelete('<%=category.getCategoryId()%>'); return false;" title="Delete">
    ...
    <script>
        function confirmDelete(categoryId) {
            if (confirm('Are you sure you want to delete this category?')) {
                window.location.href = 'deleteServiceCategory.jsp?service_id=' + categoryId;
            }
        }
    </script>
</body>
